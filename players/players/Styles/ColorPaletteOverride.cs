	...
	public ColorPaletteOverride()
	{
		...
		(
			r => r
				...
				.Add(Uno.Themes.Markup.Theme.Colors.Primary.Inverse, light: "#2A009F", dark: "#2A009F")
				...
				.Add(Uno.Themes.Markup.Theme.Colors.Surface.Inverse, light: "#E6E1E5", dark: "#E6E1E5")
