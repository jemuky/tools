...
public sealed partial class SecondPage : Page {
    public SecondPage() {
        this.DataContext<SecondViewModel>((page, vm) => page
            ...
            //         .VerticalAlignment(VerticalAlignment.Center)).Background(Theme.Brushes.Secondary.Container.Default)
            .StatusBar(foreground: StatusBarForegroundTheme.Light)
            .Resources
            (
                r => r.Add(AppIcons.Light).Add(AppIcons.Dark)
                ...
                (page, vm) => page
                    .Content(
                        new AutoLayout()
                            ...
                            .Children
                            (
                                new AutoLayout().CounterAxisAlignment(AutoLayoutAlignment.Start).Children(new NavigationBar()),
                                new AutoLayout()
                                    .MaxWidth(700)
                                    .AutoLayout(AutoLayoutAlignment.Center, primaryAlignment: AutoLayoutPrimaryAlignment.Stretch)
                                    .Children
                                    (
                                        new AutoLayout()
                                        ...
                                        new AutoLayout()
                                            ...
                                            .CounterAxisAlignment(AutoLayoutAlignment.End)
                                            .Padding(16, 8)
                                            .MinHeight(120)
                                                ...
                                                new AutoLayout()
                                                    ...
                                                    (
                                                        new Button()
                                                            ...
                                                            .AutoLayout(primaryAlignment: AutoLayoutPrimaryAlignment.Stretch, counterAlignment: AutoLayoutAlignment.Start)
                                                            .CommandParameter("C")
